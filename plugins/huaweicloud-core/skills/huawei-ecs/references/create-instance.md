...
curl -fsSL "https://mirrors.huaweicloud.com/nodejs/${NODE_VERSION}/node-${NODE_VERSION}-linux-arm64.tar.xz" -o /tmp/node.tar.xz
...
ln -sf /usr/local/lib/nodejs/node-${NODE_VERSION}-linux-arm64/bin/{node,npm,npx} /usr/local/bin/
# npm registry 指向华为云
